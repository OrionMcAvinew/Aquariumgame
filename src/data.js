...
export const FISH = [
  ...
  { id: "pleco",     name: "Plecostomus",  kind: "fish", boxSize: 2, boxCost: 34,  market: 25,  level: 4, color: 0x6b4f3a, fin: 0x3a2a1d, size: 1.25, bodyH: 0.34, pattern: "spots",   pattern2: 0x2a1d12, tail: "fan" },
  ...
  { id: "parrot",    name: "Parrot Cichlid",kind: "fish",boxSize: 2, boxCost: 52,  market: 38,  level: 5, color: 0xff4d4d, fin: 0xff8fa3, size: 1.2,  bodyH: 0.58, pattern: "solid",   pattern2: 0xff8fa3, tail: "fan" },
  ...
  { id: "bluetang",  name: "Blue Tang",    kind: "fish", boxSize: 2, boxCost: 75,  market: 55,  level: 6, color: 0x1976d2, fin: 0xffd000, size: 1.1,  bodyH: 0.54, pattern: "solid",   pattern2: 0x0d47a1, tail: "round" },
  ...
  { id: "mandarin",  name: "Mandarin Fish",kind: "fish", boxSize: 2, boxCost: 110, market: 80,  level: 7, color: 0x0a9396, fin: 0xee9b00, size: 0.95, bodyH: 0.46, pattern: "marble",  pattern2: 0xee9b00, tail: "fan" },
